 ...
 * @type {string}
 */
HelloWorker.prototype.WORKER_URI_PATH = "shared/hello";
 ...
 * @type {boolean}
 */
HelloWorker.prototype.isPublic = true;
 ...
 * @type {boolean}
 */
HelloWorker.prototype.isPersisted = true;
 ...
 * @type {boolean}
 */
HelloWorker.prototype.isStateRequiredOnStart = false;
 ...
 */
HelloWorker.prototype.onStart = function(success, error) {
    ...
    var err = false;
    if (err) {
        this.logger.severe("HelloWorker onStart error: something went wrong");
        error();
    } else {
        this.logger.fine("HelloWorker onStart success");
        success();
    }
};
 ...
 */
HelloWorker.prototype.onStartCompleted = function (success, error, state, errMsg) {
    if (errMsg) {
        this.logger.severe("HelloWorker onStartCompleted error: something went wrong " + errMsg);
        error();
    }

    this.logger.fine("HelloWorker state loaded: " + JSON.stringify(state));
    success();
};
 ...
 */
HelloWorker.prototype.onGet = function(restOperation) {
    var oThis = this;
    ...
    this.loadState(null,
        ...
        function (err, state) {
            if (err) {
                oThis.logger.warning("[HelloWorker] error loading state: %s", err.message);
 ...
 * @param {Object} restOperation
 */
HelloWorker.prototype.onPost = function(restOperation) {
 ...
 * @param {Object} restOperation
 */
HelloWorker.prototype.onPut = function(restOperation) {
    this.state = restOperation.getBody();
    this.completeRestOperation(restOperation);
};
 ...
 * @param {Object} restOperation
 */
HelloWorker.prototype.onPatch = function(restOperation) {
    this.state = restOperation.getBody();
    this.completeRestOperation(restOperation);
};
 ...
 * @param {Object} restOperation
 */
HelloWorker.prototype.onDelete = function(restOperation) {
    this.state = {};
